...
export const ManageAccess = ({
  ...
  // Add real-time subscription for project member changes
  useEffect(() => {
    const channel = supabase
      ...
      .on(
        ...
        async (payload) => {
          ...
          // Refresh the member data when changes occur
          ...
          if (updatedMembers) {
            onMembersChange?.(updatedMembers as MemberWithUser[]);
          }
        }
      )
      .subscribe();
  ...
  }, [projectId, supabase, onMembersChange]);
